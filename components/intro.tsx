    ...
    >
      <div className="flex flex-col items-center justify-center">
        <div className="relative">
          ...
          >
            <Image
              ...
              quality={95}
              priority={true}
              className="h-28 w-28 rounded-full object-cover border-[0.35rem] border-white shadow-xl shadow-black/10 transition-transform hover:scale-105"
            />
          </motion.div>
          <motion.span
        ...
        >
          ...
          <span className="italic">scalable, production-ready systems</span>.
        </motion.h1>
        ...
        >
          <Link
            href="#contact"
            className="group bg-gray-900 text-white px-7 py-3 flex items-center gap-2 rounded-full outline-none focus:scale-110 hover:scale-110 hover:bg-gray-950 active:scale-105 transition shadow-lg hover:shadow-xl dark:bg-white/10"
            onClick={() => {
          ...
          <a
            className="group bg-white px-7 py-3 flex items-center gap-2 rounded-full outline-none focus:scale-110 hover:scale-110 active:scale-105 transition cursor-pointer border border-black/10 dark:bg-white/10 dark:text-white/60 shadow-lg hover:shadow-xl"
            href="/CV.pdf"
